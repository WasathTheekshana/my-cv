...
\section{Programming Skills}
 \resumeSubHeadingListStart
   \item{
     ...
     \newline
     \textbf{Technologies}{: AWS, Azure, GCP, Docker, ELK Stack, Git, GitHub, Jenkins, Circle CI, Azure DevOps, Terraform}
     \newline
     \textbf{Frameworks, Tools \& Libraries}{: ReactJS, NextJS, Astro, NestJS, NodeJS, Trivy, SonarQube, Nexus, Grafana}
   }
 \resumeSubHeadingListEnd
